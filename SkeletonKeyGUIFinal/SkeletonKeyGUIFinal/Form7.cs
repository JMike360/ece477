    ...
    public partial class Form7 : Form
    {
        ...
        private async void button4_Click(object sender, EventArgs e)
        {
            if (isConnected)
            {
                ...
                {
                    MessageBox.Show("Incorrect Format. Try Again with 'WebsiteID,Email/Username,WesbiteURL,Password,'.");
                }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (isConnected)
            {
                ...
                {
                    MessageBox.Show("Incorrect Format. Try Again with 'WebsiteID,Email/Username,'.");
                }
            }
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (freq == 3)
            {
                    ...
                    if (str == "1")
                    {
                        MessageBox.Show("Credential Modify");
                        textBox1.Clear();
                    }
                    else if (str == "0")
                    {
            ...
            {
                MessageBox.Show("Incorrect Format. Try Again with 'WebsiteID,Email/Username,newPassword'.");
            }
        }
